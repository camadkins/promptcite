...
> lines are customized; all substantive terms are verbatim Harmony.
>
> A custom-written CLA is explicitly out of scope. The maintainer reserves
...
Your present and future Contributions to PromptCite.

## 1. Definitions

- **"You"** means the individual Copyright owner who Submits a Contribution
  to Us. If You are an employee and have created the Contribution as part of
  Your employment, You have had Your employer approve this Agreement or sign
  the Entity version of this document.
- **"Contribution"** means any original work of authorship (software and/or
  ...
  not own the Copyright in the entire work of authorship, please contact Us
  before Submitting.
...
- **"Submit"** means any form of electronic, verbal, or written
  communication sent to Us or our representatives, including but not limited
  to electronic mailing lists, source code control systems, and issue
  tracking systems that are managed by, or on behalf of, Us for the purpose
  of discussing and improving the Material, but excluding communication that
...
which We are using on the Submission Date for the Material **OR** any
licenses which are approved by the Open Source Initiative on or after the
Effective Date, including both permissive and copyleft licenses, whether or
not such licenses are subsequently disapproved (including any waiver or
exclusion that requires the Material to be distributed only under such
licenses).

We agree to license the Contribution under the **AGPL v3** as the primary
community license. We additionally reserve the right to relicense the
Contribution under proprietary commercial terms as part of the dual-license
model described in `NOTICE.md` and `LICENSE-COMMERCIAL`.

### 2.4 Moral Rights

If moral rights apply to the Contribution, to the maximum extent permitted
by the relevant law, and to the extent possible under any applicable
license, You waive and agree not to assert such moral rights against Us or
...
If You are less than eighteen years old, please have Your parents or
...
ALL CIVIL LIABILITY IN CONNECTION WITH THE CONTRIBUTION.
...
7.2 This Agreement shall apply for the term of the copyright and patents
licensed here. However, You shall have the right to terminate the
Agreement if We do not fulfill the obligations as set forth in Section
2.3. Such termination must be made in writing.

7.3 In the event of a termination of this Agreement Sections 4, 5, 6, 7
...
licenses of any Contribution that have already been licensed under the
terms of Section 2 shall not be affected by the termination of this
Agreement.
...
8.3 If You or We assign the rights or obligations received through this
...
8.4 The failure of either party to require performance by the other party
of any provision of this Agreement in one situation shall not affect the
right of such party to require such performance at any time in the
future. A waiver of performance under a provision in one situation shall
not be considered a waiver of the performance of the provision in the
future or a waiver of the provision in its entirety.

8.5 If any provision of this Agreement is found void and unenforceable,
...
**Project name:** PromptCite
**Project URL:** https://github.com/camadkins/promptcite
**Maintainer:** see `MAINTAINERS.md`
**CLA template:** Harmony HA-CLA-I-LIST 1.0
**Signing:** automated via cla-assistant.io on every pull request
